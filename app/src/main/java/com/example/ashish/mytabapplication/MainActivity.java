...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageup = (ImageView) findViewById(R.id.imageViewup);
        imageCenter = (ImageView) findViewById(R.id.imageViewcentre);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Want to make a note?", Snackbar.LENGTH_LONG)
        ...
        imageup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(MainActivity.this,RecyclerFragment.class);
                startActivity(i2);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            startActivity(new Intent(MainActivity.this,ShowPrevActivity.class));
